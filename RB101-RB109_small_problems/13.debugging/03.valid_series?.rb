...
# For the purposes of this exercise, a valid series of numbers must contain exactly 
...
# My Answer:
# On line 5 you are re-assigning 'odd_count' to be the rutrn value of the ternerary
# operator instead of checking for equivelance with 3.
# Use '==' instead of '='
